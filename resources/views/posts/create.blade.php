                            ...
                            <form action="{{ route('admin.posts.store') }}" method="POST">
                                ...
                                <div class="mb-5">
                                    ...
                                    <textarea rows="4" name="body" id="content" placeholder="Type your post content"
                                        class="w-full resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">{{ old('body') }}</textarea>
                                    @error('body')
                                        <p class="mt-2 text-sm text-red-500 italic">{{ $message }}</p>
                                    @enderror
                                </div>
